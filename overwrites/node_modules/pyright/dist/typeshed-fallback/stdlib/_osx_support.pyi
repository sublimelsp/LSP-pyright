...
def _find_executable(executable: str, path: str | None = None) -> str | None:
    ...
    """
    ...
def _read_output(commandstring: str, capture_stderr: bool = False) -> str | None:
    """Output from successful command execution or None"""
    ...
def _find_build_tool(toolname: str) -> str:
...
def _get_system_version() -> str:
    ...
    ...
def _remove_original_values(_config_vars: dict[str, str]) -> None:
    """Remove original unmodified values for testing"""
    ...
def _save_modified_value(_config_vars: dict[str, str], cv: str, newvalue: str) -> None:
    """Save modified and original unmodified value of configuration var"""
    ...
def _supports_universal_builds() -> bool:
    """Returns True if universal builds are supported on this system"""
    ...
def _find_appropriate_compiler(_config_vars: dict[str, str]) -> dict[str, str]:
    """Find appropriate C compiler for extension module builds"""
    ...
def _remove_universal_flags(_config_vars: dict[str, str]) -> dict[str, str]:
    """Remove all universal build arguments from config vars"""
    ...
def _remove_unsupported_archs(_config_vars: dict[str, str]) -> dict[str, str]:
    """Remove any unsupported archs from config vars"""
    ...
def _override_all_archs(_config_vars: dict[str, str]) -> dict[str, str]:
    """Allow override of all archs with ARCHFLAGS env var"""
    ...
def _check_for_unavailable_sdk(_config_vars: dict[str, str]) -> dict[str, str]:
